            ...
            <div class="container">
                <div class="sm:flex items-center justify-between mb-medium">
                    ...
                    <select class="sort-dropdown">
                        ...
                        <option value="mileage">Km Asc</option>
                        <option value="-mileage">Km Desc</option>
                        <option value="published_at">Newest cars added </option>
                        <option value="-published_at">Oldest cars added </option>
                        ...
                        <section class="find-a-car">
                            <form action="" method="GET" class="find-a-car-form card flex p-medium">
                                <div class="find-a-car-inputs">
                                    ...
                                    <div class="form-group">
                                        <label class="mb-medium">Km</label>
                                        <div class="flex gap-1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <x-select-region :value="request('region_id')" />
                                    </div>
                                    <div class="form-group">
